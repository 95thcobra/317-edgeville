...
public class World {
    ...
    public World(GameServer server) {
        ...
        id = Constants.WORLD_ID;
        emulation = Constants.WORLD_EMULATION;
        combatXpMult = Constants.COMBAT_XP_RATE_MULTIPLIER;
        skillingXpMult = Constants.SKILLING_XP_RATE_MULTIPLIER;
